...
- REST API with JWT auth (access + refresh token rotation), role-based access for 3 user types: student, club admin, university admin
...
- Frontend: auth-aware navbar, 3 separate dashboards, Google Maps venue finder, real-time registration and capacity tracking
...
| DevOps & Cloud | Docker · GitHub Actions · Jenkins · Vercel · Render · Neon |
| AI & ML | PyTorch · scikit-learn · Groq · Gemini API |
...
[LinkedIn](https://linkedin.com/in/amisha-sharma-53a5a2270) · [Email](mailto:amishasharma2220@gmail.com)
